...
Chart::Chart(Plot *plot, const wxString &title, const wxColour &bgColor)
{
    Init(plot, new Header(title), NULL, bgColor);
}

Chart::Chart(Plot* plot, Header* header, Footer* footer, const wxColour &bgColor)
{
    Init(plot, header, footer, bgColor);
}

void Chart::Init(Plot* plot, Header* header, Footer* footer, const wxColour &bgColor)
{
	// defaults
