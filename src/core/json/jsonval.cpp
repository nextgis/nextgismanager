...
wxJSONValue wxJSONValue::operator [] ( unsigned index ) const
{
    wxJSONValue v = ItemAt( index );
    return v;
}

wxJSONValue wxJSONValue::operator [] ( const wxString& key ) const
{
    wxJSONValue v = ItemAt( key );
    return v;
}
