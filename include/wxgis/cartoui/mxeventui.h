...
wxDECLARE_EXPORTED_EVENT(WXDLLIMPEXP_GIS_CTU, wxMXMAP_CLEARED, wxMxMapViewUIEvent);
...
#define EVT_MXMAP_CLEARED(func)  wx__DECLARE_EVT0(wxMXMAP_CLEARED, wxMxMapViewUIEventHandler(func))
