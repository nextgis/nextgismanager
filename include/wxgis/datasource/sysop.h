...
WXDLLIMPEXP_GIS_DS inline bool IsFileDataset(wxGISEnumDatasetType eDSType, long SubType)
{
    ...
    case enumGISTable:
    {
        wxGISEnumTableType eSubType = (wxGISEnumTableType)SubType;
        switch (eSubType)
        {
...
WXDLLIMPEXP_GIS_DS bool CreateDir(const CPLString &sPath, long mode = 0775, ITrackCancel* const pTrackCancel = NULL);
